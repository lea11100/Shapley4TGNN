...
if "shapley_event" in selected:
    ...
    result_shapley_edge.to_csv(f"Documents/ExplainerOutputs/{CONFIG.data.dataset_name}_Shapley4TGNNEvent.csv", index=False)
...
if "shapley_feature" in selected:
    ...
    result_shapley_feat.to_csv(f"Documents/ExplainerOutputs/{CONFIG.data.dataset_name}_Shapley4TGNNFeature.csv", index=False)
...
if "tgnn" in selected:
    ...
    result_tgnnexpl.to_csv(f"Documents/ExplainerOutputs/{CONFIG.data.dataset_name}_TGNNExplainer.csv", index=False)
...
if "tempme" in selected:
    ...
    result_tempme.to_csv(f"Documents/ExplainerOutputs/{CONFIG.data.dataset_name}_TempME.csv", index=False)
...
if selected == {"shapley_event", "shapley_feature", "tgnn", "tempme"}:
